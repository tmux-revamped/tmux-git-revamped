...
| [`tmux-git-revamped`](https://github.com/tmux-revamped/tmux-git-revamped) | **this plugin**, Git repository status in your tmux status bar, without ever blocking the render |
